...
const colorClasses: Record<string, string> = {
  ...
  light: 'text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-gray-100 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 dark:border-gray-600 dark:focus:ring-gray-700',
};
